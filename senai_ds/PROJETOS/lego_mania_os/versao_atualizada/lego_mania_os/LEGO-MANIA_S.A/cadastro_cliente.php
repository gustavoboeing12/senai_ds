                                    ...
                                    <form action="cadastro_cliente.php" method="POST">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="text" class="form-control" id="cpf_cnpj" name="cpf_cnpj" placeholder="000.000.000-00 ou 00.000.000/0000-00" oninput="mascaraCPFCNPJ()" required>
                                            </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="text" class="form-control" id="cep" name="cep" placeholder="00000-000" oninput="mascaraCEP()">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="tel" class="form-control" id="telefone" name="telefone" placeholder="(00) 00000-0000" oninput="mascaraTelefone()" required>
                                            </div>
                                        </div>
